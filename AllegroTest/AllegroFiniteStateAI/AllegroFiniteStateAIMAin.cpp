...
int main(int argc, char **argv)
{
	...
	//PROJECT VARIABLES
	//==============================================
	int state = -1; // all the state changes have to go through ChangeState
	...
	int threshold = 175; // mens the area teh enemies will spot and chase you
	//==============================================
	//ALLEGRO VARIABLES
	//==============================================
	...
	//the game has just started and the first thing is the menu
	...
	while(!done)
	{
		...
		else if(ev.type == ALLEGRO_EVENT_TIMER)
		{
			...
			if(state == IDLE){
				...
				// he's is 5 pixels away from the origin means he is near
